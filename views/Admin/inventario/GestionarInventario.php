...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h2 class="card-title mb-0">Gestión de Inventario</h2>
        <div class="d-flex gap-2">
            <a href="/admin/GestionarProducto" class="btn btn-light text-primary fw-bold">Ir a Productos</a>
            <a href="/admin/GestionarCompras" class="btn btn-light text-success fw-bold">Ir a Compras</a>
        </div>
    </div>
</div>
                        ...
                        <tr class="<?= $registro->cantidad_actual < $registro->cantidad_minima ? 'table-danger' : '' ?>">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="/admin/VerProducto?id=<?= $registro->producto_idproducto ?>" class="btn btn-sm btn-outline-info">
                                        <i class="fas fa-eye"></i> Detalles
                                    </a>
                                    <a href="/admin/GenerarCodigoBarras?id=<?= $registro->producto_idproducto ?>" class="btn btn-sm btn-outline-dark">
