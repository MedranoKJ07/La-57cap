...
<div class="mb-3">
    <a href="/admin/reportes/ventas-categoria-pdf?inicio=<?= $fechaInicio ?>&fin=<?= $fechaFin ?>" target="_blank"
        class="btn btn-danger me-2">
        <i class="fas fa-file-pdf me-1"></i> Exportar a PDF
    </a>
    <a href="/admin/reportes/ventas-categoria-excel?inicio=<?= $fechaInicio ?>&fin=<?= $fechaFin ?>"
