<div class="row g-3">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" name="proveedor[nombre_empresa]" required
            value="<?php echo s($proveedor->nombre_empresa); ?>">
    </div>

    <div class="col-md-6">
        <label for="contacto" class="form-label">Contacto</label>
        <input type="text" class="form-control" name="proveedor[contacto]" required
            value="<?php echo s($proveedor->contacto); ?>">
    </div>

    <div class="col-md-6">
        <label for="telefono" class="form-label">Teléfono</label>
        <input type="text" class="form-control" name="proveedor[telefono]" required
            value="<?php echo s($proveedor->telefono); ?>">
    </div>

    <div class="col-md-6">
        <label for="direccion" class="form-label">Dirección</label>
        <input type="text" class="form-control" name="proveedor[direccion]" required
